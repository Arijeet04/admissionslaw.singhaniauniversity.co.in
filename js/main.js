(function($) {
    ...
    const scriptURL = "https://script.google.com/macros/s/AKfycbzrrlimifuLlZj-A3_kv0G25S3CusycqQl3s3YEcQBU_QIb2L06OEUpcnUed5YlaTpk/exec";
    ...
    $("#submitForm").click(function(event) {
        ...
        $.ajax({
            ...
            data: JSON.stringify({
                ...
                otherparams: [{
                        "meta_key": "lead_name",
                        "meta_value": "SU_2025_EDXSO_DIGITAL"
                    },
                    {
                        "meta_key": "convenient_time",
                        "meta_value": connectTime
                    }
                ]
            }),
            success: function(response) {
